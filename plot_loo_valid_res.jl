...
worst_mae_doy = argmax(mae_loc)
println("worst MAE DOY: ", worst_mae_doy)
println("worst MAE: ", mae_loc[worst_mae_doy])
println("")

println("days ≤ 0.02 MAE: ", mean(mae_loc .< 0.02))
println("")
...
worst_pred_int_high_ind = argmax(int_day_loc[:, high_doy]-ints)
...
println("median bias: ", median(bias_loc))
